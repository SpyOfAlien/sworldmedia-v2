...
const ServicePage = ({ service, profile }) => {
  ...
  return (
    <div className="sw-w-4/5 sw-mx-auto sw-my-32">
      <section className="sw-flex sw-mb-24 sw-justify-between">
        <div className="sw-w-4/5">
          <div></div>
          <h1 className="sw-text-h3 sw-font-bold sw-text-white sw-mb-12">
            {summary}
          </h1>
        </div>
      ...
      <section>
        <h3 className="sw-text-h3 sw-text-center sw-font-bold sw-text-white sw-mb-12">
          Khám phá dịch vụ
        </h3>
      ...
      <section className="sw-my-40">
        <div className="sw-text-center sw-text-white sw-mb-24">
          <h3 className="sw-text-h3 sw-font-bold">Đánh giá của Khách Hàng</h3>
          <p className="sw-gilroy-thin sw-text-sm sw-w-3/5 sw-mx-auto">
