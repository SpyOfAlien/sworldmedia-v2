...
const Profile = ({ profile }) => {
  ...
  return (
    <div className="sw-relative sw-py-12 sw-text-white sw-text-center">
      <div className={cn('sw-absolute sw-inset-0', s.glow)}></div>
      <h3 className="sw-font-bold sw-text-h3 sw-mb-8">
        {t('service__profile')}
      </h3>
      <p className={cn('sw-gilroy-thin sw-w-3/5 sw-mx-auto sw-mb-8', s.legal)}>
      ...
      <div className="sw-flex sw-justify-center">
        <button
          ...
          className={cn(
            'sw-rounded-sm focus:sw-outline-none sw-flex sw-items-center sw-py-3 sw-px-12 sw-bg-opacity-500 sw-mr-8',
            s.btn
          )}
        >
